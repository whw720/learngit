 ...
 * @version 2013-3-21
 */
Ext.define('com.dfsoft.icu.nws.nursingscores.sapstwo.SapsTwoForm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.sapstwoform',
    requires: [
        'com.dfsoft.icu.nws.nursingscores.sapstwo.SapsTwoGrid',
    'com.dfsoft.icu.nws.nursingscores.sapstwo.ValueCount',
    ...
    /*分值项目录入验证*/
    itemVerification: function (sapstwoitem) {
        var me = this;
        ...
        if (sapstwoitem.sapstwo.Eyes == "") {
            Ext.Msg.alert("提示", "请选择睁眼反应");
            me.itemscore = "";
            return false;
        }
        if (sapstwoitem.sapstwo.Language == "") {
            Ext.Msg.alert("提示", "请选择语言反应");
            me.itemscore = "";
            return false;
        }
        if (sapstwoitem.sapstwo.Motor == "") {
    ...
    initComponent: function () {
        ...
        me.apacheTwoGrid = new com.dfsoft.icu.nws.nursingscores.sapstwo.SapsTwoGrid();
        me.changCalc = new com.dfsoft.icu.nws.nursingscores.sapstwo.ValueCount();
                    ...
                    items: [
                        ...
                        ,
                        {
                            ...
                            handler: function (btn) {
                                ...
                                var toppanel = Ext.getCmp(btn.ownerCt.ownerCt.mod + 'sapstwotoppanel');
                                var intervalTime = 24;
                                //创建遮罩效果
                        ...
                        '-',
                        {
                            ...
                            handler: function (btn) {
                                ...
                                var toppanel = Ext.getCmp(me.mod + 'sapstwotoppanel');
                                //表单验证.
                                ...
                                //拼装项目明细字串
                                me.itemscore = '{"sapstwo":{' + me.itemscore.substr(0, me.itemscore.length - 1) + '}}';
                                //转换为对象
                                var sapstwoitem = Ext.JSON.decode(me.itemscore);
                               contentStr =  me.itemscore;
                                Ext.Ajax.request({
                                    url: parent.webRoot + '/app/nws/nursingscores/sapstwo/ChangeScores.json',
                                    async: false,
                                ...
                                scores = me.changCalc.scoresCount(ChangeScores, sapstwoitem);
                                saps3Scores = me.changCalc.scoresKzCount(ChangeScores, sapstwoitem);// 扩展计算得分
                                saps3Scores = me.changCalc.scoresSaps3(scores,saps3Scores);
                                mr = me.changCalc.calcDeath(saps3Scores);
                                //显示计算结果窗口
                                var cw = Ext.create('com.dfsoft.icu.nws.nursingscores.sapstwo.CountWindow',
                                    {
                                        scores: scores,
                        ...
                        '-',
                        {
                            ...
                            iconCls: 'ico-help',
                            handler: function (btn) {
                                var hw = Ext.create('com.dfsoft.icu.nws.nursingscores.HelpWindow',{itempath:'sapstwo'});
                                var pmod = btn.ownerCt.ownerCt.mod;
        ...
        var scoreCode = "9a5675edb18811e3aa8800271396a820";

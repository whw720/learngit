...
Ext.define('com.dfsoft.icu.nws.nursingscores.opossum.ValueCount', {
    /*
    ...
    * */
    ...
    CalcMorta:function(zapa,zapaa){
       ...
       var  zmorta = 0;//并发症概率
        ...
        czapaa = (zapaa * 0.19) + czapa;
        zmorta = 1 / (1 + Math.exp(-czapaa));

        return me.Fmt(100 * zmorta) + " %";
...
// 计算死亡率
    ...
    * */
    scoresCount:function(ChangeScores,opossumItem){
        var me = this;
        var scorescount = 0;
        ...
        * */
        ...
        for(var be in opossumItem.opossum){
            var itemtype = "";
            var itemscore = 0;
            itemtype = be;
            itemscore = eval("opossumItem.opossum."+be);

...
Ext.define('com.dfsoft.icu.nws.nursingscores.possum.ValueCount', {
    /*
...
// 计算死亡率
    CalcMort:function(zapa,zapaa) {
        ...
        var czapaa = 0;//手术分值
        var  zmort = 0;//死亡率
        czapa = (0.13 * zapa) - 7.04;
        czapaa = (zapaa * 0.16) + czapa;
    ...
    * */
    scoresCount:function(ChangeScores,possumItem){
        ...
        * */
        ...
        for(var be in possumItem.possum){
            var itemtype = "";
            var itemscore = 0;
            itemtype = be;
            itemscore = eval("possumItem.possum."+be);

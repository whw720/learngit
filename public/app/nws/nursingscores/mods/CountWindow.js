...
Ext.define('com.dfsoft.icu.nws.nursingscores.mods.CountWindow', {
    ...
    saveData: function (callback) {
        ...
        var CATEGORY_CODE = "9a1d4c2db18811e3aa8800271396a820";   //评分类型ID（２８种评分 对应数据库 dic_scores_category表 code）
        ...
        var routeItems = "得分:" + me.scores + ",死亡率:" + this.mr + ",ICU驻留天数:" + me.icuDay;

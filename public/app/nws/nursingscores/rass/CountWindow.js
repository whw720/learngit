...
Ext.define('com.dfsoft.icu.nws.nursingscores.rass.CountWindow', {
    ...
    saveData: function(callback) {
        ...
        var CATEGORY_CODE = "e93438952db211e4bb7c5cff350ba2ff";   //评分类型ID（２８种评分 对应数据库 dic_scores_category表 code）

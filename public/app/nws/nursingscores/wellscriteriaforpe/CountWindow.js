...
Ext.define('com.dfsoft.icu.nws.nursingscores.wellscriteriaforpe.CountWindow', {
    ...
    saveData: function(callback) {
        ...
        var CATEGORY_CODE = "9ab0ec1db18811e3aa8800271396a820";   //评分类型ID（２８种评分 对应数据库 dic_scores_category表 code）
            ...
            Ext.Ajax.request({
                ...
                success: function(response) {
                    ...
                    if (reqmsg.success === true) {
                        ...
                        msg.popup('提示：','Well’s Criteria for PE评分保存成功！');
                        me.close();

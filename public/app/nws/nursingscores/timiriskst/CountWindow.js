...
Ext.define('com.dfsoft.icu.nws.nursingscores.timiriskst.CountWindow', {
    ...
    saveData: function(callback) {
        ...
        var CATEGORY_CODE = "9a8f1287b18811e3aa8800271396a820";   //评分类型ID（２８种评分 对应数据库 dic_scores_category表 code）
            ...
            Ext.Ajax.request({
                ...
                success: function(response) {
                    ...
                    if (reqmsg.success === true) {
                        ...
                        msg.popup('提示：','TIMI Risk-ST评分保存成功！');
                        me.close();
                    } else {

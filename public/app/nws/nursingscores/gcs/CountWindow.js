...
Ext.define('com.dfsoft.icu.nws.nursingscores.gcs.CountWindow', {
    ...
    saveData: function(callback) {
        ...
        var CATEGORY_CODE = "b7dcf05cb18711e3aa8800271396a820";   //评分类型ID（２８种评分 对应数据库 dic_scores_category表 code）
                    ...
                    if (reqmsg.success === true) {
                       ...
                       // console.log(reqmsg);
                        ...
                        if(me.parent.mod.indexOf("care_record") != -1) {
                            me.parent.popw.saveRecordScore(me.scores, me.rcItem,reqmsg.data,2);
                            SCORES_TIME =  me.parent.popw.careTime;
                        }
                        msg.popup('提示：','GCS评分保存成功！');
                        me.close();
                    } else {

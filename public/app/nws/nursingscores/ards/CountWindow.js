...
Ext.define('com.dfsoft.icu.nws.nursingscores.ards.CountWindow', {
    ...
    saveData: function(callback) {
        ...
        var CATEGORY_CODE = "9a4bcbb4b18811e3aa8800271396a820";   //评分类型ID（２８种评分 对应数据库 dic_scores_category表 code）

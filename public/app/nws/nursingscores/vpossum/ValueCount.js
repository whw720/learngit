...
Ext.define('com.dfsoft.icu.nws.nursingscores.vpossum.ValueCount', {
    /*
...
// 计算死亡率
    CalcMort:function(zapa,zapaa) {
        ...
        var czapaa = 0;//手术分值
        var  zmort = 0;//死亡率
        czapa = (0.1552 * zapa) - 8.0616;
        czapaa = (zapaa * 0.1238) + czapa;
    ...
    * */
    scoresCount:function(ChangeScores,possumItem){
        var me = this;
        var scorescount = 0;
        ...
        * */
        ...
        for(var be in possumItem.vpossum){
            var itemtype = "";
            var itemscore = 0;
            itemtype = be;
            itemscore = eval("possumItem.vpossum."+be);

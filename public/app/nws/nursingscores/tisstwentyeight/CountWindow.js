...
Ext.define('com.dfsoft.icu.nws.nursingscores.tisstwentyeight.CountWindow', {
    ...
    saveData: function(callback) {
        ...
        var CATEGORY_CODE = "5ef78370228711e3b33cadce3eaap78c";   //评分类型ID（２８种评分 对应数据库 dic_scores_category表 code）

...
Ext.define('com.dfsoft.icu.nws.nursingscores.apachetwo.CountWindow', {
    ...
    saveData: function(callback) {
        ...
        var CATEGORY_CODE = "9a10f3ebb18811e3aa8800271396a820";   //评分类型ID（２８种评分 对应数据库 dic_scores_category表 code）

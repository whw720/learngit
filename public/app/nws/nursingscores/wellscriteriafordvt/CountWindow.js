...
Ext.define('com.dfsoft.icu.nws.nursingscores.wellscriteriafordvt.CountWindow', {
    ...
    saveData: function(callback) {
        ...
        var CATEGORY_CODE = "9aa55314b18811e3aa8800271396a820";   //评分类型ID（２８种评分 对应数据库 dic_scores_category表 code）
                ...
                success: function(response) {
                    ...
                    if (reqmsg.success === true) {
                       ...
                       // me.parent.operType = 'edit';
                        ...
                        msg.popup('提示：','Well’s Criteria for DVT评分保存成功！');
                        me.close();
                        //callback(me.parent.operType);
                    } else {

...
Ext.define('com.dfsoft.icu.nws.nursingscores.mpmtwo.CountWindow', {
                ...
                success: function(response) {
                    ...
                    if (reqmsg.success === true) {
                        ...
                        if(me.parent.mod.indexOf("care_record") != -1) {
                            me.parent.popw.saveRecordScore("0", "死亡率:" + me.mr,reqmsg.data,2);
                            SCORES_TIME =  me.parent.popw.careTime;
                        }
                        msg.popup('提示：','MPM Ⅱ-24-72评分保存成功！');
                        me.parent.itemscore = "";
                        me.close();
                    } else {

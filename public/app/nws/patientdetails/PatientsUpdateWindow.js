 ...
 * @author: 姬魁
 */
Ext.define('com.dfsoft.icu.nws.patientdetails.PatientsUpdateWindow', {
    extend: 'Ext.window.Window',
    requires: [
        'com.dfsoft.icu.nws.patientdetails.PatientsUpdateForm',
        'com.dfsoft.icu.nws.patientdetails.PatientsNewEntity'
    ],
    initComponent :function(){
        var me = this;
        me.patientsDetailsForm = new com.dfsoft.icu.nws.patientdetails.PatientsUpdateForm();
...
//            }
            myMask.show();
            Ext.Ajax.request({
            	url: webRoot + '/nws/icu_patient/updateWaitDept/' + values.REGISTER_ID,
                method: 'PUT',
                params: {

 ...
 * @version 2013-9-27
 */
Ext.define('com.dfsoft.icu.nws.nursingrecord.PipeStomachGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.pipeStomachgrid',
    ...
    initComponent: function () {
        ...
        var wStore=new Ext.data.Store({
            ...
            proxy: {
                ...
                url: webRoot+'/icu/nursingRecord/pipeline/queryPipeDic?category=胃管',
                reader: {
                    type: 'json',
                    root: 'data'
                }

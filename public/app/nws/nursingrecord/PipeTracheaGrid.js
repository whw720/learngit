 ...
 * @version 2013-9-27
 */
Ext.define('com.dfsoft.icu.nws.nursingrecord.PipeTracheaGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.pipeTracheagrid',
    ...
    initComponent: function () {
        ...
        var wStore= new Ext.data.Store({
            ...
            proxy: {
                ...
                url: webRoot+'/icu/nursingRecord/pipeline/queryPipeDic?category=人工气道',
                reader: {
                    type: 'json',
                    root: 'data'
                }
        ...
        var xingTypeStore=new Ext.data.SimpleStore({
        ...
        Ext.apply(me, {
            ...
            listeners:{
                cellclick:function(_this, td, cellIndex, record, tr, rowIndex, e, eOpts ){
                    ...
                    }else if(modifiedFieldNames=='OXYGEN_MODE'){
                        column.setEditor({
                            xtype: 'combobox',
                            editable: false,
                            maxLength:20,

 ...
 * @author: zag
 */
Ext.define('com.dfsoft.icu.nws.nursingevaluation.EvalWaterlowsRiskPanel', {
    extend: 'Ext.panel.Panel',
    requires: ['com.dfsoft.icu.nws.nursingevaluation.EvalToolbar'],

    title: "waterlow's危险因素评估",
    closable: true,
    width: 500,
    border: false,
    maximizable: true,
    constructor: function(config) {
        ...
        var proxy = this;
        this.id = this.mod +'evalWaterlowsRiskPanel';
        ...
        this.callParent([{
            ...
            items: [this.evalToolbar,{
                xtype: 'panel',
                region: 'center',
                html: '<iframe id="'+this.mod+'evalWaterlowsRisk" frameborder="0" src="/templates/' + templates + '/nws_eval_waterlows_risk.html?PATIENT_ID=' + patientId + '&REGISTER_ID=' + registerId + '&MOD=' + this.mod + '" width="100%" height="100%"></iframe>'
            }]
        }]);
    ...
    setPatientInfo:function(patientInfo){
        ...
        var aframe = document.getElementById(this.mod+'evalWaterlowsRisk').contentWindow;

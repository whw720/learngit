 ...
 */
Ext.define('com.dfsoft.icu.dws.doctorordermanagement.PageTreeStore', {
    ...
    onProxyLoad: function(operation) {
        ...
        if (resultSet) {
            if(node.parentNode==null){
                me.whwTotalCount=resultSet.total;
            }
        }
        me.whwCurrentCount=resultSet.count;
        me.loading = false;

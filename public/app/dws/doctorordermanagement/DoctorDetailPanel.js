 ...
 * @date:2014-3-5.
 */
Ext.define('com.dfsoft.icu.dws.doctorordermanagement.DoctorDetailPanel', {
            ...
            dockedItems: [
                {
                    ...
                    items: [
                        {
                            xtype: 'label',
                            html: '<img src="/app/dws/doctorordermanagement/images/doctor-ask-small.png" />',
                            width: '10px'},
                        {
                            xtype: 'label',
                            text: '医嘱详情'
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {xtype: 'combo',
                                    ...
                                    width: '33.5%',
                                    fieldLabel: '患者姓名',
                                    value: me.parent.record.PATIENT_ID,
                                    labelWidth: 58,
                                    name:'detail-name',
                                    labelAlign: 'right',
                                    valueField: 'ID',
                                    ...
                                    store: new Ext.data.Store({
                                        ...
                                        proxy: {
                                            type: 'ajax',
                                            url: webRoot + '/dws/doctorordermanagement/query_patient?userId=' + userInfo.userId,
                                            reader: {
                                                type: 'json',
                                                root: 'data'
                                            }
                                ...
                                },
                                {
                                    ...
                                    format: 'Y-m-d H:i',
                                    width: '36.4%',
                                    value: me.parent.record.COLLECT_TIME==null?new Date():new Date(me.parent.record.COLLECT_TIME),//Ext.Date.parse(me.parent.record.COLLECT_TIME, 'Y-m-d H:i:s'),
                                    editable: false,
                                    //msgTarget: 'none',
                                    //preventMark: true,
                                    allowBlank: false,
